...
const NotFound = () => {
  return (
    <div>
      <div class="bg-primary-dark h-screen justify-center flex flex-col items-center">
        <center class=" m-auto">
          <svg
            class="emoji-404 "
          ...
          <div class=" tracking-widest mt-4">
            <span class="text-primary-blue text-6xl block">
              <span>4 0 4</span>
            </span>
            <span class="text-white text-xl">Trang Không tìm thấy !</span>
          </div>
          <div class="mt-6">
            <Link to="/">
              <button className="text-white font-bold text-center font-mono text-xl bg-primary-blue p-3 rounded-md hover:shadow-md">
                Trang Chủ
              </button>
            </Link>
          </div>
