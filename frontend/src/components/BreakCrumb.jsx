...
const BreakCrumb = ({ heading }) => {
  ...
  return (
    <div
      className="bg-cover bg-center  py-20 w-full"
      style={{ backgroundImage: `url(${bgBreakCrumb})` }}
    >
      <div className="container max-w-screen-xl mx-auto  w-full">
        <div className="  w-full">
          <div className="flex items-center gap-4 text-white font-medium text-[1rem] mb-6  w-full">
          ...
          <h1 className="h-full w-full text-white font-arya text-4xl">{heading}</h1>
        </div>
      </div>
    </div>
  );
