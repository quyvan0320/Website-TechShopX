...
const Footer = () => {
  ...
  return (
    ...
    <div className="bg-primary-bgthin">
      <div className="container max-w-screen-xl mx-auto px-4 lg:px-0 pt-8 pb-4 border-b">
        <div className="flex justify-between items-center">
          <h3 className="hidden md:block  text-xl font-bold text-white font-arya ">
        ...
        <div className="flex-col flex md:flex-row justify-between items-center mt-1">
          <div className="flex items-center gap-2">
            ...
            />
            <button className="btn-hover-effect w-full md:w-1/3 h-[3rem]">
      ...
      <div className="grid grid-cols-2 gap-6 md:gap-0 container max-w-screen-xl mx-auto py-6 px-4 md:px-0 md:flex md:justify-around">
        <div className="space-y-3">
          <h3 className="text-xl md:text-3xl uppercase font-bold text-white font-arya ">
            Khách
          </h3>
    ...
    <div className="bg-white">
      <div className="container max-w-screen-xl mx-auto py-4 px-4 md:px-0 flex flex-col md:flex-row justify-between items-center">
        <h1 className="font-normal text-sm text-primary-bgthin mb-2 md:mb-0">© 2024, TechShopX, Cung cấp bởi Nhóm 1</h1>
